    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border border-black/10 rounded-lg p-8 mb-12">
          <h1 className="text-4xl font-light text-black mb-4">Technical SEO</h1>
          <p className="text-black/70">
            Analysis of your website's technical aspects including mobile-friendliness, accessibility, and crawlability.
